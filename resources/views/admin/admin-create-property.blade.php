...
@section('title', '- Admin Dashboard - Crear Propiedad')
        ...
        <div class="dashboard-wrapper">
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Crear una Propiedad</h5>
                            <div class="card-body">
                                <form class="needs-validation" action="{{ route('property.create') }}" role="form" enctype="multipart/form-data" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 mb-2 mt-4">
                                            <button class="btn btn-primary" type="submit">Crear Propiedad</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
