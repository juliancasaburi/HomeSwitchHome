...
@section('title', '- Mi Cuenta - Modificar datos personales')
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-influence">
                <div class="container-fluid dashboard-content">
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Modificar datos personales</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <!-- content  -->
                    <!-- ============================================================== -->
                    <form class="needs-validation" action="{{ route('user.modifyData') }}" role="form" method="POST">
                        <input type="hidden" name="_method" value="PUT">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <label for="nombre">Nombre</label>
                            <input type="text" class="form-control @error('nombre') is-invalid @enderror" name="nombre" id="nombre" value="{{ Auth::user()->nombre }}" autofocus>
                            @error('nombre')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('apellido') is-invalid @enderror" name="apellido" id="apellido" value="{{ Auth::user()->apellido }}" autofocus>
                            @error('apellido')
                            <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="pais" id="inputPais">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('fecha_nacimiento') is-invalid @enderror" name="fecha_nacimiento" id="inputFechaNacimiento" value="{{ Auth::user()->fecha_nacimiento }}" oninput="validarFechaNacimiento()" required autocomplete="off">
